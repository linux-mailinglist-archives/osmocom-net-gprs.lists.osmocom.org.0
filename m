...
Received: from mail.osmocom.org (mail.osmocom.org [IPv6:2001:780:45:1d::46:82])
	by mail.lfdr.de (Postfix) with ESMTPS id 5D428A3709B
	for <lists+osmocom-net-gprs@lfdr.de>; Sat, 15 Feb 2025 21:34:13 +0100 (CET)
Received: from localhost (mail.osmocom.org [127.0.0.1])
	by mail.osmocom.org (Postfix) with ESMTP id 4312F1E8819;
	Sat, 15 Feb 2025 20:34:13 +0000 (UTC)
Received: from mail.osmocom.org ([127.0.0.1])
 by localhost (mail.osmocom.org [127.0.0.1]) (amavis, port 10024) with ESMTP
 id 0VsZ3aZ0jfwy; Sat, 15 Feb 2025 20:34:12 +0000 (UTC)
Received: from [127.0.1.1] (unknown [IPv6:2a01:4f8:120:8470::1:7])
	by mail.osmocom.org (Postfix) with ESMTP id E05FA1E8802;
	Sat, 15 Feb 2025 20:34:10 +0000 (UTC)
Received: from mail.osmocom.org (mail.osmocom.org [IPv6:2001:780:45:1d::46:82])
	by lists (Postfix) with ESMTPS id 43FF138A0F5F
	for <osmocom-net-gprs@lists.osmocom.org>; Mon, 10 Feb 2025 13:30:39 +0000 (UTC)
Received: from localhost (mail.osmocom.org [127.0.0.1])
	by mail.osmocom.org (Postfix) with ESMTP id 263C01E1B00
	for <osmocom-net-gprs@lists.osmocom.org>; Mon, 10 Feb 2025 13:30:39 +0000 (UTC)
Received: from mail.osmocom.org ([127.0.0.1])
 by localhost (mail.osmocom.org [127.0.0.1]) (amavis, port 10024) with ESMTP
 id eTPiDxr3oOC0 for <osmocom-net-gprs@lists.osmocom.org>;
 Mon, 10 Feb 2025 13:30:37 +0000 (UTC)
Received: from mail-pl1-x62d.google.com (mail-pl1-x62d.google.com [IPv6:2607:f8b0:4864:20::62d])
	by mail.osmocom.org (Postfix) with ESMTPS id 7B72D1E1AFB
	for <osmocom-net-gprs@lists.osmocom.org>; Mon, 10 Feb 2025 13:30:37 +0000 (UTC)
Received: by mail-pl1-x62d.google.com with SMTP id d9443c01a7336-21f92258aa6so26130315ad.3
        for <osmocom-net-gprs@lists.osmocom.org>; Mon, 10 Feb 2025 05:30:37 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20230601; t=1739194236; x=1739799036; darn=lists.osmocom.org;
        h=content-transfer-encoding:mime-version:references:in-reply-to
         :message-id:date:subject:cc:to:from:from:to:cc:subject:date
         :message-id:reply-to;
        bh=133k00XYUKhM1CLkQRscpJPFuQqBgZ8D5itO6oI4RDY=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=133k00XYUKhM1CLkQRscpJPFuQqBgZ8D5itO6oI4RDY=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCX9PLmBa/UpuhAINyBJxi+HPfP78ip+4FKksBw/ZM8ZWzh6A2rg5i+Kq4BDFoxqz9cg0eTxAJZxNFg4u+l3QABV@lists.osmocom.org
X-Gm-Message-State: AOJu0YwsgaflMChy+K6iPIdIetci/2OmQFitQBFzBArTCLy65YRZxh+A
	nyhRneGRVASBPd/Gkyylj+cD616UgpflGpH/4CEtCUFk+OldkLrq
X-Gm-Gg: 
...
Archived-At: <https://lists.osmocom.org/hyperkitty/list/osmocom-net-gprs@lists.osmocom.org/message/OLYHMCIYSZ2IKNMJOXIHTBU6MWQIMNEH/>
...
@@ -4397,10 +4397,13 @@ static int vxlan_nl2conf(struct nlattr *tb[], str=
uct nlattr *data[],
 	return 0;
 }
=20
...
@@ -3766,7 +3766,13 @@ static int rtnl_newlink_create(struct sk_buff *skb=
...
@@ -3791,13 +3797,14 @@ static int rtnl_newlink_create(struct sk_buff *sk=
