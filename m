...
Received: from mail.osmocom.org (mail.osmocom.org [IPv6:2001:780:45:1d::46:82])
	by mail.lfdr.de (Postfix) with ESMTPS id C969A4CD952
	for <lists+osmocom-net-gprs@lfdr.de>; Fri,  4 Mar 2022 17:41:52 +0100 (CET)
Received: from localhost (localhost [127.0.0.1])
	by mail.osmocom.org (Postfix) with ESMTP id 158FE2812C;
	Fri,  4 Mar 2022 16:41:51 +0000 (UTC)
Received: from mail.osmocom.org ([127.0.0.1])
	by localhost (mail.osmocom.org [127.0.0.1]) (amavisd-new, port 10024)
	with ESMTP id Zr9CTdo_9s-N; Fri,  4 Mar 2022 16:41:49 +0000 (UTC)
Received: from [127.0.1.1] (unknown [IPv6:2a01:4f8:120:8470::1:7])
	by mail.osmocom.org (Postfix) with ESMTP id 17E8228121;
	Fri,  4 Mar 2022 16:41:45 +0000 (UTC)
Received: from mail.osmocom.org (mail.osmocom.org [IPv6:2001:780:45:1d::46:82])
	by lists (Postfix) with ESMTPS id 4266338A0A78
	for <osmocom-net-gprs@lists.osmocom.org>; Fri,  4 Mar 2022 16:41:33 +0000 (UTC)
Received: from localhost (localhost [127.0.0.1])
	by mail.osmocom.org (Postfix) with ESMTP id DC0DC2812C
	for <osmocom-net-gprs@lists.osmocom.org>; Fri,  4 Mar 2022 16:41:32 +0000 (UTC)
Received: from mail.osmocom.org ([127.0.0.1])
	by localhost (mail.osmocom.org [127.0.0.1]) (amavisd-new, port 10024)
	with ESMTP id Y1WOYzPkF4wL for <osmocom-net-gprs@lists.osmocom.org>;
	Fri,  4 Mar 2022 16:41:27 +0000 (UTC)
Received: from mga11.intel.com (mga11.intel.com [192.55.52.93])
	by mail.osmocom.org (Postfix) with ESMTPS id C7D9328128
	for <osmocom-net-gprs@lists.osmocom.org>; Fri,  4 Mar 2022 16:41:21 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  ...
  b=LIUVyQETW8LfL3dF5MGht77lggNJUKUVJKV+qMWTQ/SmJb+7WTGBnh+u
   50H8EtGrZ2njHF+V80NOvZE1W7pMVjzvYkFEKu42vZYTudfTd+JWjFglK
   nVUKAfwqIxWgZVhiFu2hNj1wVU8PHkVrBhQAXG+pVJU2AIBiJYBP5dMRN
   pdkse+2fb1ejTUv/03xo/f5bOQ42HmD7E0zkfSq/xNDGbo0wFR/ZZOBu4
   chAVh1hzMDMdwnF/4CzmyBXmcGvIel8DJ71Z5fg8Pbe+Yic7FEXT1xFv9
   QGdnA40sYBeoZaw5FHhL40X7h3RPLvDvA/fn33wpOPiXgMue0M6gq10A+
   w==;
X-IronPort-AV: E=McAfee;i="6200,9189,10276"; a="251585600"
X-IronPort-AV: E=Sophos;i="5.90,155,1643702400";
   d="scan'208";a="251585600"
Received: from orsmga005.jf.intel.com ([10.7.209.41])
  by fmsmga102.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 04 Mar 2022 08:41:19 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.90,155,1643702400";
   d="scan'208";a="710386234"
Received: from irvmail001.ir.intel.com ([10.43.11.63])
  by orsmga005.jf.intel.com with ESMTP; 04 Mar 2022 08:41:09 -0800
Received: from rozewie.igk.intel.com (rozewie.igk.intel.com [10.211.8.69])
	by irvmail001.ir.intel.com (8.14.3/8.13.6/MailSET/Hub) with ESMTP id 224Gf12N020994;
	Fri, 4 Mar 2022 16:41:08 GMT
From: Marcin Szycik <marcin.szycik@linux.intel.com>
To: netdev@vger.kernel.org
Subject: [PATCH net-next v10 7/7] ice: Support GTP-U and GTP-C offload in switchdev
...
Message-ID-Hash: MHYA2O6277OQPUIBRQ6NMMWUKWK4CHWR
X-Message-ID-Hash: MHYA2O6277OQPUIBRQ6NMMWUKWK4CHWR
...
Archived-At: <https://lists.osmocom.org/hyperkitty/list/osmocom-net-gprs@lists.osmocom.org/message/MHYA2O6277OQPUIBRQ6NMMWUKWK4CHWR/>
...
@@ -4782,16 +5283,17 @@ ice_find_dummy_packet(struct ice_adv_lkup_elem *l=
kups, u16 lkups_cnt,
...
@@ -4799,11 +5301,85 @@ ice_find_dummy_packet(struct ice_adv_lkup_elem *l=
kups, u16 lkups_cnt,
...
@@ -4818,7 +5394,7 @@ ice_find_dummy_packet(struct ice_adv_lkup_elem *lku=
ps, u16 lkups_cnt,
=20
...
@@ -4831,7 +5407,7 @@ ice_find_dummy_packet(struct ice_adv_lkup_elem *lku=
ps, u16 lkups_cnt,
 		return;
 	}
=20
...
@@ -4842,7 +5418,7 @@ ice_find_dummy_packet(struct ice_adv_lkup_elem *lku=
ps, u16 lkups_cnt,
...
@@ -4853,7 +5429,7 @@ ice_find_dummy_packet(struct ice_adv_lkup_elem *lku=
ps, u16 lkups_cnt,
...
@@ -4958,6 +5534,10 @@ ice_fill_adv_dummy_packet(struct ice_adv_lkup_elem=
 *lkups, u16 lkups_cnt,
 		case ICE_GENEVE:
