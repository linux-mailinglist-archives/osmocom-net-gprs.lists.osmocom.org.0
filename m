...
Received: from lists.osmocom.org (lists.osmocom.org [144.76.43.76])
	by mail.lfdr.de (Postfix) with ESMTP id AD2D16E216
	for <lists+osmocom-net-gprs@lfdr.de>; Fri, 19 Jul 2019 09:58:58 +0200 (CEST)
Received: from lists.osmocom.org (lists.osmocom.org [144.76.43.76])
	by lists.osmocom.org (Postfix) with ESMTP id 16F93C563D;
	Fri, 19 Jul 2019 07:58:58 +0000 (UTC)
Authentication-Results: lists.osmocom.org; dmarc=none header.from=kernel.org
Authentication-Results: lists.osmocom.org;
	dkim=fail reason="signature verification failed" (1024-bit key; unprotected) header.d=kernel.org header.i=@kernel.org header.b=o9xREfEy
...
Received: from mail.kernel.org (mail.kernel.org [198.145.29.99])
 by lists.osmocom.org (Postfix) with ESMTP id 5A435AC55F
 for <osmocom-net-gprs@lists.osmocom.org>; Mon, 15 Jul 2019 14:17:43 +0000 (UTC)
Received: from sasha-vm.mshome.net (unknown [73.61.17.35])
 (using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
 (No client certificate requested)
 by mail.kernel.org (Postfix) with ESMTPSA id 40A43206B8;
 Mon, 15 Jul 2019 14:17:41 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
 s=default; t=1563200262;
 bh=oq0jh/VRHHsuOtF2ed6LdS+l8yfxbvHCjK0taZc6NMo=;
 h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
 b=o9xREfEyprIWYlZeGCScB2XtMtkiv5dMy5obxfg0pBXmElczMCftUsVEhgazymTh+
 losVNKtuv8RhLiPiZT/CAij1yqKbXXbJB5dJRzZxvdYA+z8JZhZLpFLyiXDdmuP+4y
 DDvOc8euTS+kWkAdRl4AOte4VmEIA1AenUuF5fe4=
From: Sasha Levin <sashal@kernel.org>
To: linux-kernel@vger.kernel.org,
	stable@vger.kernel.org
Subject: [PATCH AUTOSEL 5.1 217/219] gtp: fix use-after-free in gtp_newlink()
Date: Mon, 15 Jul 2019 10:03:38 -0400
Message-Id: <20190715140341.6443-217-sashal@kernel.org>
