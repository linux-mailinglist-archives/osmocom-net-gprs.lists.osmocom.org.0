...
Received: from mail.osmocom.org (mail.osmocom.org [IPv6:2001:780:45:1d::46:82])
	by mail.lfdr.de (Postfix) with ESMTPS id 15A459D10A6
	for <lists+osmocom-net-gprs@lfdr.de>; Mon, 18 Nov 2024 13:38:21 +0100 (CET)
Received: from localhost (mail.osmocom.org [127.0.0.1])
	by mail.osmocom.org (Postfix) with ESMTP id E678E181FD1;
	Mon, 18 Nov 2024 12:38:20 +0000 (UTC)
Received: from mail.osmocom.org ([127.0.0.1])
 by localhost (mail.osmocom.org [127.0.0.1]) (amavis, port 10024) with ESMTP
 id 8P9tYypxJ80M; Mon, 18 Nov 2024 12:38:19 +0000 (UTC)
Received: from [127.0.1.1] (unknown [IPv6:2a01:4f8:120:8470::1:7])
	by mail.osmocom.org (Postfix) with ESMTP id 544E5181FAE;
	Mon, 18 Nov 2024 12:38:18 +0000 (UTC)
Received: from mail.osmocom.org (mail.osmocom.org [IPv6:2001:780:45:1d::46:82])
	by lists (Postfix) with ESMTPS id D4B6F38A18D0
	for <osmocom-net-gprs@lists.osmocom.org>; Wed, 13 Nov 2024 12:58:14 +0000 (UTC)
Received: from localhost (mail.osmocom.org [127.0.0.1])
	by mail.osmocom.org (Postfix) with ESMTP id BBB6C17B322
	for <osmocom-net-gprs@lists.osmocom.org>; Wed, 13 Nov 2024 12:58:14 +0000 (UTC)
Received: from mail.osmocom.org ([127.0.0.1])
 by localhost (mail.osmocom.org [127.0.0.1]) (amavis, port 10024) with ESMTP
 id Gpi3KwjmZRlF for <osmocom-net-gprs@lists.osmocom.org>;
 Wed, 13 Nov 2024 12:58:13 +0000 (UTC)
Received: from mail-pg1-x529.google.com (mail-pg1-x529.google.com [IPv6:2607:f8b0:4864:20::529])
	by mail.osmocom.org (Postfix) with ESMTPS id 3EED217B31D
	for <osmocom-net-gprs@lists.osmocom.org>; Wed, 13 Nov 2024 12:58:12 +0000 (UTC)
Received: by mail-pg1-x529.google.com with SMTP id 41be03b00d2f7-7d4f85766f0so4919985a12.2
        for <osmocom-net-gprs@lists.osmocom.org>; Wed, 13 Nov 2024 04:58:12 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20230601; t=1731502691; x=1732107491; darn=lists.osmocom.org;
        h=content-transfer-encoding:mime-version:references:in-reply-to
         :message-id:date:subject:cc:to:from:from:to:cc:subject:date
         :message-id:reply-to;
        bh=c4uHKNgHTelYlny2krcQ638zz7tT9VKe4QfYY382d0Q=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=c4uHKNgHTelYlny2krcQ638zz7tT9VKe4QfYY382d0Q=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCVCPoZzA9avJyQ2dC+kkss7lX0B9a5GAletuQB7Wsxt9Qh/5fzJwaKKlHhzueuuGbXPI9ruEuO2tRNOQ+sVnffd@lists.osmocom.org
X-Gm-Message-State: AOJu0YybSzUjcpYeJgYsFq5FSheZu9SxmKS/uhg9QB5ZXa9eaguEw8ve
	hm1jI+FSQkHUARGF3F9T1NP8FbSIwdAsj0Ki678jbCeXFhtm6Bet
...
Archived-At: <https://lists.osmocom.org/hyperkitty/list/osmocom-net-gprs@lists.osmocom.org/message/YFOHY57N7IW4IYLIEBXAB2HEG4KA5HAA/>
...
@@ -97,7 +97,8 @@ static int ipoib_changelink(struct net_device *dev, str=
uct nlattr *tb[],
 	return ret;
 }
=20
...
+				struct net_device *dev,
 ...
 {
@@ -109,7 +110,8 @@ static int ipoib_new_child_link(struct net *src_net, =
struct net_device *dev,
 	if (!tb[IFLA_LINK])
 		return -EINVAL;
=20
-	pdev =3D __dev_get_by_index(src_net, nla_get_u32(tb[IFLA_LINK]));
+	pdev =3D __dev_get_by_index(rtnl_link_netns(nets),
...
--- a/drivers/net/amt.c
+++ b/drivers/net/amt.c
@@ -3161,14 +3161,14 @@ static int amt_validate(struct nlattr *tb[], stru=
ct nlattr *data[],
 	return 0;
 }
=20
-static int amt_newlink(struct net *net, struct net_device *dev,
+static int amt_newlink(struct rtnl_link_nets *nets, struct net_device *d=
ev,
 		       struct nlattr *tb[], struct nlattr *data[],
 		       struct netlink_ext_ack *extack)
 {
...
=20
-	amt->net =3D net;
+	amt->net =3D rtnl_link_netns(nets);
 	amt->mode =3D nla_get_u32(data[IFLA_AMT_MODE]);
=20
 	if (data[IFLA_AMT_MAX_TUNNELS] &&
@@ -3183,7 +3183,7 @@ static int amt_newlink(struct net *net, struct net_=
device *dev,
 	amt->hash_buckets =3D AMT_HSIZE;
 	amt->nr_tunnels =3D 0;
 	get_random_bytes(&amt->hash_seed, sizeof(amt->hash_seed));
-	amt->stream_dev =3D dev_get_by_index(net,
+	amt->stream_dev =3D dev_get_by_index(rtnl_link_netns(nets),
...
@@ -698,7 +698,7 @@ static void bareudp_dellink(struct net_device *dev, s=
truct list_head *head)
 	unregister_netdevice_queue(dev, head);
 }
=20
-static int bareudp_newlink(struct net *net, struct net_device *dev,
+static int bareudp_newlink(struct rtnl_link_nets *nets, struct net_devic=
e *dev,
 			   struct nlattr *tb[], struct nlattr *data[],
 			   struct netlink_ext_ack *extack)
 {
@@ -709,7 +709,7 @@ static int bareudp_newlink(struct net *net, struct ne=
t_device *dev,
 	if (err)
 		return err;
=20
-	err =3D bareudp_configure(net, dev, &conf, extack);
+	err =3D bareudp_configure(rtnl_link_netns(nets), dev, &conf, extack);
 	if (err)
 		return err;
=20
...
@@ -564,7 +564,8 @@ static int bond_changelink(struct net_device *bond_de=
v, struct nlattr *tb[],
 	return 0;
 }
=20
...
@@ -624,7 +624,7 @@ static int can_fill_xstats(struct sk_buff *skb, const=
 struct net_device *dev)
 	return -EMSGSIZE;
 }
=20
-static int can_newlink(struct net *src_net, struct net_device *dev,
+static int can_newlink(struct rtnl_link_nets *nets, struct net_device *d=
ev,
 		       struct nlattr *tb[], struct nlattr *data[],
 		       struct netlink_ext_ack *extack)
 {
...
+static int vxcan_newlink(struct rtnl_link_nets *nets, struct net_device =
*dev,
 			 struct nlattr *tb[], struct nlattr *data[],
 			 struct netlink_ext_ack *extack)
 {
@@ -203,7 +203,7 @@ static int vxcan_newlink(struct net *net, struct net_=
device *dev,
 		name_assign_type =3D NET_NAME_ENUM;
 	}
=20
-	peer_net =3D rtnl_link_get_net(net, tbp);
+	peer_net =3D rtnl_link_get_net(rtnl_link_netns(nets), tbp);
...
@@ -117,7 +117,7 @@ static void rmnet_unregister_bridge(struct rmnet_port=
 *port)
 	rmnet_unregister_real_device(bridge_dev);
 }
=20
-static int rmnet_newlink(struct net *src_net, struct net_device *dev,
+static int rmnet_newlink(struct rtnl_link_nets *nets, struct net_device =
*dev,
 			 struct nlattr *tb[], struct nlattr *data[],
 			 struct netlink_ext_ack *extack)
 {
@@ -134,7 +134,8 @@ static int rmnet_newlink(struct net *src_net, struct =
net_device *dev,
 		return -EINVAL;
 	}
=20
-	real_dev =3D __dev_get_by_index(src_net, nla_get_u32(tb[IFLA_LINK]));
+	real_dev =3D __dev_get_by_index(rtnl_link_netns(nets),
+				      nla_get_u32(tb[IFLA_LINK]));
 	if (!real_dev) {
...
@@ -1614,7 +1614,7 @@ static void geneve_link_config(struct net_device *d=
ev,
 	geneve_change_mtu(dev, ldev_mtu - info->options_len);
 }
=20
-static int geneve_newlink(struct net *net, struct net_device *dev,
+static int geneve_newlink(struct rtnl_link_nets *nets, struct net_device=
 *dev,
 			  struct nlattr *tb[], struct nlattr *data[],
 			  struct netlink_ext_ack *extack)
 {
@@ -1631,7 +1631,7 @@ static int geneve_newlink(struct net *net, struct n=
et_device *dev,
 	if (err)
 		return err;
=20
-	err =3D geneve_configure(net, dev, extack, &cfg);
+	err =3D geneve_configure(rtnl_link_netns(nets), dev, extack, &cfg);
 	if (err)
 		return err;
=20
...
--- a/drivers/net/gtp.c
+++ b/drivers/net/gtp.c
@@ -1460,7 +1460,7 @@ static int gtp_create_sockets(struct gtp_dev *gtp, =
...
+static int gtp_newlink(struct rtnl_link_nets *nets, struct net_device *d=
ev,
 		       struct nlattr *tb[], struct nlattr *data[],
 		       struct netlink_ext_ack *extack)
 {
@@ -1494,7 +1494,7 @@ static int gtp_newlink(struct net *src_net, struct =
net_device *dev,
 	gtp->restart_count =3D nla_get_u8_default(data[IFLA_GTP_RESTART_COUNT],
 						0);
=20
-	gtp->net =3D src_net;
+	gtp->net =3D rtnl_link_netns(nets);
=20
...
@@ -166,7 +166,7 @@ struct ipvl_addr *ipvlan_addr_lookup(struct ipvl_port=
 *port, void *lyr3h,
...
+int ipvlan_link_new(struct rtnl_link_nets *nets, struct net_device *dev,
 		    ...
 		    struct netlink_ext_ack *extack)
 {
@@ -545,7 +545,8 @@ int ipvlan_link_new(struct net *src_net, struct net_d=
evice *dev,
 	if (!tb[IFLA_LINK])
 		return -EINVAL;
=20
-	phy_dev =3D __dev_get_by_index(src_net, nla_get_u32(tb[IFLA_LINK]));
+	phy_dev =3D __dev_get_by_index(rtnl_link_netns(nets),
+				     nla_get_u32(tb[IFLA_LINK]));
 	if (!phy_dev)
 		return -ENODEV;
=20
...
+static int ipvtap_newlink(struct rtnl_link_nets *nets, struct net_device=
 *dev,
 			  struct nlattr *tb[], struct nlattr *data[],
 			  struct netlink_ext_ack *extack)
 {
...
+	err =3D  ipvlan_link_new(nets, dev, tb, data, extack);
 	if (err) {
...
@@ -4141,7 +4141,7 @@ static int macsec_add_dev(struct net_device *dev, s=
ci_t sci, u8 icv_len)
=20
 static struct lock_class_key macsec_netdev_addr_lock_key;
=20
-static int macsec_newlink(struct net *net, struct net_device *dev,
+static int macsec_newlink(struct rtnl_link_nets *nets, struct net_device=
 *dev,
 			  struct nlattr *tb[], struct nlattr *data[],
 			  struct netlink_ext_ack *extack)
 {
@@ -4154,7 +4154,8 @@ static int macsec_newlink(struct net *net, struct n=
et_device *dev,
=20
 	if (!tb[IFLA_LINK])
 		return -EINVAL;
...
+static int macvlan_newlink(struct rtnl_link_nets *nets, struct net_devic=
e *dev,
 			   struct nlattr *tb[], struct nlattr *data[],
 			   struct netlink_ext_ack *extack)
 {
...
+static int macvtap_newlink(struct rtnl_link_nets *nets, struct net_devic=
e *dev,
 			   struct nlattr *tb[], struct nlattr *data[],
 			   struct netlink_ext_ack *extack)
 {
...
+	err =3D macvlan_common_newlink(rtnl_link_netns(nets), dev, tb, data,
+				     extack);
 	if (err) {
 		netdev_rx_handler_unregister(dev);
 		return err;
...
+static int netkit_new_link(struct rtnl_link_nets *nets, struct net_devic=
e *dev,
 			   struct nlattr *tb[], struct nlattr *data[],
 			   struct netlink_ext_ack *extack)
 {
@@ -385,7 +385,7 @@ static int netkit_new_link(struct net *src_net, struc=
t net_device *dev,
 	    (tb[IFLA_ADDRESS] || tbp[IFLA_ADDRESS]))
 		return -EOPNOTSUPP;
=20
-	net =3D rtnl_link_get_net(src_net, tbp);
+	net =3D rtnl_link_get_net(rtnl_link_netns(nets), tbp);
...
+static int pfcp_newlink(struct rtnl_link_nets *nets, struct net_device *=
dev,
 			struct nlattr *tb[], struct nlattr *data[],
 			struct netlink_ext_ack *extack)
 {
@@ -192,7 +192,7 @@ static int pfcp_newlink(struct net *net, struct net_d=
evice *dev,
 	struct pfcp_net *pn;
 	int err;
=20
-	pfcp->net =3D net;
+	pfcp->net =3D rtnl_link_netns(nets);
=20
...
@@ -1303,7 +1303,7 @@ static int ppp_nl_validate(struct nlattr *tb[], str=
uct nlattr *data[],
 	return 0;
 }
=20
-static int ppp_nl_newlink(struct net *src_net, struct net_device *dev,
+static int ppp_nl_newlink(struct rtnl_link_nets *nets, struct net_device=
 *dev,
 			  struct nlattr *tb[], struct nlattr *data[],
 			  struct netlink_ext_ack *extack)
 {
@@ -1343,7 +1343,7 @@ static int ppp_nl_newlink(struct net *src_net, stru=
ct net_device *dev,
...
+	err =3D ppp_dev_configure(rtnl_link_netns(nets), dev, &conf);
=20
 out_unlock:
...
+static int team_newlink(struct rtnl_link_nets *nets, struct net_device *=
dev,
 			struct nlattr *tb[], struct nlattr *data[],
 			struct netlink_ext_ack *extack)
 {
...
+static int veth_newlink(struct rtnl_link_nets *nets, struct net_device *=
dev,
 			struct nlattr *tb[], struct nlattr *data[],
 			struct netlink_ext_ack *extack)
 {
@@ -1800,7 +1800,7 @@ static int veth_newlink(struct net *src_net, struct=
 net_device *dev,
 		name_assign_type =3D NET_NAME_ENUM;
 	}
=20
...
--- a/drivers/net/vrf.c
+++ b/drivers/net/vrf.c
@@ -1698,7 +1698,7 @@ static void vrf_dellink(struct net_device *dev, str=
uct list_head *head)
 	unregister_netdevice_queue(dev, head);
 }
=20
-static int vrf_newlink(struct net *src_net, struct net_device *dev,
+static int vrf_newlink(struct rtnl_link_nets *nets, struct net_device *d=
ev,
 		       struct nlattr *tb[], struct nlattr *data[],
 		       struct netlink_ext_ack *extack)
 {
...
@@ -4345,7 +4345,7 @@ static int vxlan_nl2conf(struct nlattr *tb[], struc=
t nlattr *data[],
 	return 0;
 }
=20
-static int vxlan_newlink(struct net *src_net, struct net_device *dev,
+static int vxlan_newlink(struct rtnl_link_nets *nets, struct net_device =
*dev,
 			 struct nlattr *tb[], struct nlattr *data[],
 			 struct netlink_ext_ack *extack)
 {
@@ -4356,7 +4356,7 @@ static int vxlan_newlink(struct net *src_net, struc=
t net_device *dev,
 	if (err)
 		return err;
=20
...
+static int wg_newlink(struct rtnl_link_nets *nets, struct net_device *de=
v,
 		      struct nlattr *tb[], struct nlattr *data[],
 		      struct netlink_ext_ack *extack)
 {
...
@@ -519,7 +519,8 @@ static rx_handler_result_t virt_wifi_rx_handler(struc=
t sk_buff **pskb)
 }
=20
...
+			     struct net_device *dev,
 			     ...
 			     struct netlink_ext_ack *extack)
 {
@@ -532,7 +533,7 @@ static int virt_wifi_newlink(struct net *src_net, str=
uct net_device *dev,
 	netif_carrier_off(dev);
=20
 	priv->upperdev =3D dev;
-	priv->lowerdev =3D __dev_get_by_index(src_net,
+	priv->lowerdev =3D __dev_get_by_index(rtnl_link_netns(nets),
 					    nla_get_u32(tb[IFLA_LINK]));
=20
 	if (!priv->lowerdev)
...
@@ -967,7 +967,8 @@ static struct net_device *wwan_rtnl_alloc(struct nlat=
tr *tb[],
 	return dev;
 }
=20
...
+			     struct net_device *dev,
 			     ...
 			     struct netlink_ext_ack *extack)
 {
@@ -1064,6 +1065,7 @@ static void wwan_create_default_link(struct wwan_de=
vice *wwandev,
 	struct net_device *dev;
 	struct nlmsghdr *nlh;
 	struct sk_buff *msg;
+	struct rtnl_link_nets nets =3D { .src_net =3D &init_net };
=20
 	/* Forge attributes required to create a WWAN netdev. We first
 	 * build a netlink message and then parse it. This looks
@@ -1105,7 +1107,7 @@ static void wwan_create_default_link(struct wwan_de=
vice *wwandev,
...
@@ -69,6 +69,26 @@ static inline int rtnl_msg_family(const struct nlmsghd=
r *nlh)
 		return AF_UNSPEC;
 }
=20
...
+};
+
+/* Get effective link netns from struct rtnl_link_nets. Generally, this =
is
+ * link_net and falls back to src_net. But for compatibility, a driver m=
ay
...
@@ -135,7 +135,7 @@ static int vlan_changelink(struct net_device *dev, st=
ruct nlattr *tb[],
 	return 0;
 }
=20
-static int vlan_newlink(struct net *src_net, struct net_device *dev,
+static int vlan_newlink(struct rtnl_link_nets *nets, struct net_device *=
dev,
 			struct nlattr *tb[], struct nlattr *data[],
 			struct netlink_ext_ack *extack)
 {
@@ -155,7 +155,8 @@ static int vlan_newlink(struct net *src_net, struct n=
et_device *dev,
 		return -EINVAL;
 	}
=20
...
@@ -1063,7 +1063,7 @@ static int batadv_softif_validate(struct nlattr *tb=
[], struct nlattr *data[],
=20
 /**
...
@@ -1071,7 +1071,8 @@ static int batadv_softif_validate(struct nlattr *tb=
[], struct nlattr *data[],
  *
...
@@ -1553,7 +1553,7 @@ static int br_changelink(struct net_device *brdev, =
struct nlattr *tb[],
 	return 0;
 }
=20
-static int br_dev_newlink(struct net *src_net, struct net_device *dev,
+static int br_dev_newlink(struct rtnl_link_nets *nets, struct net_device=
 *dev,
 			  struct nlattr *tb[], struct nlattr *data[],
 			  struct netlink_ext_ack *extack)
 {
...
+static int ipcaif_newlink(struct rtnl_link_nets *nets, struct net_device=
 *dev,
 			  struct nlattr *tb[], struct nlattr *data[],
 			  struct netlink_ext_ack *extack)
 {
...
@@ -3750,6 +3750,10 @@ static int rtnl_newlink_create(struct sk_buff *skb=
, struct ifinfomsg *ifm,
 	struct net_device *dev;
 	char ifname[IFNAMSIZ];
 	int err;
+	struct rtnl_link_nets nets =3D {
+		.src_net =3D net,
...
=20
 	if (!ops->alloc && !ops->setup)
 		return -EOPNOTSUPP;
@@ -3761,8 +3765,8 @@ static int rtnl_newlink_create(struct sk_buff *skb,=
 struct ifinfomsg *ifm,
 		name_assign_type =3D NET_NAME_ENUM;
 	}
=20
...
+			       extack);
 	if (IS_ERR(dev)) {
 		err =3D PTR_ERR(dev);
 		goto out;
@@ -3771,7 +3775,7 @@ static int rtnl_newlink_create(struct sk_buff *skb,=
 struct ifinfomsg *ifm,
 	dev->ifindex =3D ifm->ifi_index;
=20
 	if (ops->newlink)
-		err =3D ops->newlink(link_net ? : net, dev, tb, data, extack);
+		err =3D ops->newlink(&nets, dev, tb, data, extack);
 	else
 		err =3D register_netdevice(dev);
 	if (err < 0) {
@@ -3782,11 +3786,6 @@ static int rtnl_newlink_create(struct sk_buff *skb=
, struct ifinfomsg *ifm,
...
@@ -29,7 +29,7 @@ static const struct nla_policy hsr_policy[IFLA_HSR_MAX =
+ 1] =3D {
 /* Here, it seems a netdevice has already been allocated for us, and the
  * hsr_dev_setup routine has been executed. Nice!
  */
-static int hsr_newlink(struct net *src_net, struct net_device *dev,
+static int hsr_newlink(struct rtnl_link_nets *nets, struct net_device *d=
ev,
 		       struct nlattr *tb[], struct nlattr *data[],
 		       struct netlink_ext_ack *extack)
 {
@@ -46,7 +46,7 @@ static int hsr_newlink(struct net *src_net, struct net_=
device *dev,
 		NL_SET_ERR_MSG_MOD(extack, "Slave1 device not specified");
 		return -EINVAL;
 	}
-	link[0] =3D __dev_get_by_index(src_net,
+	link[0] =3D __dev_get_by_index(rtnl_link_netns(nets),
 				     nla_get_u32(data[IFLA_HSR_SLAVE1]));
 	if (!link[0]) {
 		NL_SET_ERR_MSG_MOD(extack, "Slave1 does not exist");
@@ -56,7 +56,7 @@ static int hsr_newlink(struct net *src_net, struct net_=
device *dev,
 		NL_SET_ERR_MSG_MOD(extack, "Slave2 device not specified");
 		return -EINVAL;
 	}
-	link[1] =3D __dev_get_by_index(src_net,
+	link[1] =3D __dev_get_by_index(rtnl_link_netns(nets),
 				     nla_get_u32(data[IFLA_HSR_SLAVE2]));
 	if (!link[1]) {
 		NL_SET_ERR_MSG_MOD(extack, "Slave2 does not exist");
@@ -69,7 +69,7 @@ static int hsr_newlink(struct net *src_net, struct net_=
device *dev,
 	}
=20
 	if (data[IFLA_HSR_INTERLINK])
-		interlink =3D __dev_get_by_index(src_net,
+		interlink =3D __dev_get_by_index(rtnl_link_netns(nets),
...
@@ -129,7 +129,7 @@ static int lowpan_validate(struct nlattr *tb[], struc=
t nlattr *data[],
 	return 0;
 }
=20
-static int lowpan_newlink(struct net *src_net, struct net_device *ldev,
+static int lowpan_newlink(struct rtnl_link_nets *nets, struct net_device=
 *ldev,
 			  struct nlattr *tb[], struct nlattr *data[],
 			  struct netlink_ext_ack *extack)
 {
...
-	wdev =3D dev_get_by_index(dev_net(ldev), nla_get_u32(tb[IFLA_LINK]));
+	wdev =3D dev_get_by_index(nets->link_net ? : dev_net(ldev),
+				nla_get_u32(tb[IFLA_LINK]));
 	if (!wdev)
 		return -ENODEV;
...
+static int ipgre_newlink(struct rtnl_link_nets *nets, struct net_device =
*dev,
 			 struct nlattr *tb[], struct nlattr *data[],
 			 struct netlink_ext_ack *extack)
 {
+	struct net *net =3D nets->link_net ? : dev_net(dev);
 	struct ip_tunnel_parm_kern p;
 	__u32 fwmark =3D 0;
 	int err;
@@ -1404,13 +1405,14 @@ static int ipgre_newlink(struct net *src_net, str=
uct net_device *dev,
...
+static int erspan_newlink(struct rtnl_link_nets *nets, struct net_device=
 *dev,
 			  struct nlattr *tb[], struct nlattr *data[],
 			  struct netlink_ext_ack *extack)
 {
+	struct net *net =3D nets->link_net ? : dev_net(dev);
 	...
 	__u32 fwmark =3D 0;
 	int err;
@@ -1422,7 +1424,7 @@ static int erspan_newlink(struct net *src_net, stru=
ct net_device *dev,
...
@@ -1695,6 +1697,7 @@ struct net_device *gretap_fb_dev_create(struct net =
*net, const char *name,
 	LIST_HEAD(list_kill);
 	struct ip_tunnel *t;
 	int err;
+	struct rtnl_link_nets nets =3D { .src_net =3D net };
=20
 	memset(&tb, 0, sizeof(tb));
=20
@@ -1707,7 +1710,7 @@ struct net_device *gretap_fb_dev_create(struct net =
*net, const char *name,
 	t =3D netdev_priv(dev);
 	t->collect_md =3D true;
=20
-	err =3D ipgre_newlink(net, dev, tb, NULL, NULL);
+	err =3D ipgre_newlink(&nets, dev, tb, NULL, NULL);
 	if (err < 0) {
 		free_netdev(dev);
 		return ERR_PTR(err);
...
+static int vti_newlink(struct rtnl_link_nets *nets, struct net_device *d=
ev,
 		       struct nlattr *tb[], struct nlattr *data[],
 		       struct netlink_ext_ack *extack)
 {
@@ -583,7 +583,8 @@ static int vti_newlink(struct net *src_net, struct ne=
t_device *dev,
 	__u32 fwmark =3D 0;
=20
...
+static int ipip_newlink(struct rtnl_link_nets *nets, struct net_device *=
dev,
 			struct nlattr *tb[], struct nlattr *data[],
 			struct netlink_ext_ack *extack)
 {
@@ -453,7 +453,8 @@ static int ipip_newlink(struct net *src_net, struct n=
et_device *dev,
 	}
=20
...
=20
 	err =3D register_netdevice(dev);
 	if (err)
@@ -2005,12 +2005,12 @@ static int ip6gre_newlink_common(struct net *src_=
net, struct net_device *dev,
 	return err;
 }
=20
-static int ip6gre_newlink(struct net *src_net, struct net_device *dev,
+static int ip6gre_newlink(struct rtnl_link_nets *nets, struct net_device=
 *dev,
 			  struct nlattr *tb[], struct nlattr *data[],
 			  struct netlink_ext_ack *extack)
 {
...
+	struct net *net =3D nets->link_net ? : dev_net(dev);
 	...
 	int err;
=20
@@ -2025,7 +2025,7 @@ static int ip6gre_newlink(struct net *src_net, stru=
ct net_device *dev,
 			return -EEXIST;
 	}
=20
...
@@ -2241,12 +2241,13 @@ static void ip6erspan_tap_setup(struct net_device=
 *dev)
 	netif_keep_dst(dev);
 }
=20
...
+	struct net *net =3D nets->link_net ? : dev_net(dev);
 	...
 	int err;
=20
@@ -2262,7 +2263,7 @@ static int ip6erspan_newlink(struct net *src_net, s=
truct net_device *dev,
 			return -EEXIST;
 	}
=20
...
+	err =3D ip6_tnl_create2(net, dev);
 	if (err < 0)
 		goto failed_free;
=20
@@ -2002,11 +2001,11 @@ static void ip6_tnl_netlink_parms(struct nlattr *=
data[],
 		parms->fwmark =3D nla_get_u32(data[IFLA_IPTUN_FWMARK]);
 }
=20
-static int ip6_tnl_newlink(struct net *src_net, struct net_device *dev,
+static int ip6_tnl_newlink(struct rtnl_link_nets *nets, struct net_devic=
e *dev,
 			   struct nlattr *tb[], struct nlattr *data[],
 			   struct netlink_ext_ack *extack)
 {
...
+	struct net *net =3D nets->link_net ? : dev_net(dev);
 	...
 	struct ip6_tnl *nt, *t;
@@ -2031,7 +2030,7 @@ static int ip6_tnl_newlink(struct net *src_net, str=
uct net_device *dev,
 			return -EEXIST;
 	}
=20
...
+static int vti6_newlink(struct rtnl_link_nets *nets, struct net_device *=
dev,
 			struct nlattr *tb[], struct nlattr *data[],
 			struct netlink_ext_ack *extack)
 {
...
=20
 	if (!parms->name[0])
@@ -1550,11 +1549,11 @@ static bool ipip6_netlink_6rd_parms(struct nlattr=
 *data[],
 }
 #endif
=20
-static int ipip6_newlink(struct net *src_net, struct net_device *dev,
+static int ipip6_newlink(struct rtnl_link_nets *nets, struct net_device =
*dev,
 			 struct nlattr *tb[], struct nlattr *data[],
 			 struct netlink_ext_ack *extack)
 {
...
@@ -1575,7 +1574,7 @@ static int ipip6_newlink(struct net *src_net, struc=
t net_device *dev,
...
-			struct nlattr *tb[], struct nlattr *data[],
-			struct netlink_ext_ack *extack)
+static int xfrmi_newlink(struct rtnl_link_nets *nets, struct net_device =
*dev,
+			 struct nlattr *tb[], struct nlattr *data[],
+			 struct netlink_ext_ack *extack)
 {
...
+	struct net *net =3D nets->link_net ? : dev_net(dev);
 	...
 	struct xfrm_if *xi;
 	int err;
@@ -851,7 +850,7 @@ static int xfrmi_newlink(struct net *src_net, struct =
net_device *dev,
 	xi->net =3D net;
 	xi->dev =3D dev;
=20
