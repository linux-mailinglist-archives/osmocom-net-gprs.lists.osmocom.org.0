...
Received: from lists.osmocom.org (lists.osmocom.org [IPv6:2a01:4f8:191:444b::2:7])
	by mail.lfdr.de (Postfix) with ESMTP id EB93F6E20D
	for <lists+osmocom-net-gprs@lfdr.de>; Fri, 19 Jul 2019 09:58:48 +0200 (CEST)
Received: from lists.osmocom.org (lists.osmocom.org [144.76.43.76])
	by lists.osmocom.org (Postfix) with ESMTP id CF5D8C55D3;
	Fri, 19 Jul 2019 07:58:45 +0000 (UTC)
Authentication-Results: lists.osmocom.org; dmarc=none header.from=kernel.org
Authentication-Results: lists.osmocom.org;
	dkim=fail reason="signature verification failed" (1024-bit key; unprotected) header.d=kernel.org header.i=@kernel.org header.b=ixkkB2ar
...
Received: from mail.kernel.org (mail.kernel.org [198.145.29.99])
 by lists.osmocom.org (Postfix) with ESMTP id 25719AC426
 for <osmocom-net-gprs@lists.osmocom.org>; Mon, 15 Jul 2019 14:08:03 +0000 (UTC)
Received: from sasha-vm.mshome.net (unknown [73.61.17.35])
 (using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
 (No client certificate requested)
 by mail.kernel.org (Postfix) with ESMTPSA id 5D42A2083D;
 Mon, 15 Jul 2019 14:02:46 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
 s=default; t=1563199368;
 bh=bM7uSQcdpSnqrQfQmkmr9p2Sfs518Bd1c1HB6AY6Qww=;
 h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
 b=ixkkB2ar7absYQG8G9Z/VOMTG+9Hz7voliCvGvRf7LKc6RGW80Rx8ES8+cUlRPoo8
 pJatfArSz2s5fISEz2KXv7KjOV7RRRBcZhhyjftkqjN5Xzs7vY6Kuhf98XISlbWqOC
 UBGZjv94ko/ZXGghpzgJFH7184omvzI11KUh55e0=
From: Sasha Levin <sashal@kernel.org>
To: linux-kernel@vger.kernel.org,
	stable@vger.kernel.org
Subject: [PATCH AUTOSEL 5.2 245/249] gtp: fix Illegal context switch in RCU
 read-side critical section.
Date: Mon, 15 Jul 2019 09:46:50 -0400
Message-Id: <20190715134655.4076-245-sashal@kernel.org>
