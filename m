...
Received: from mail.osmocom.org (mail.osmocom.org [IPv6:2001:780:45:1d::46:82])
	by mail.lfdr.de (Postfix) with ESMTPS id 70AE64C3533
	for <lists+osmocom-net-gprs@lfdr.de>; Thu, 24 Feb 2022 19:56:42 +0100 (CET)
Received: from localhost (localhost [127.0.0.1])
	by mail.osmocom.org (Postfix) with ESMTP id 379172838D;
	Thu, 24 Feb 2022 18:56:42 +0000 (UTC)
Received: from mail.osmocom.org ([127.0.0.1])
	by localhost (mail.osmocom.org [127.0.0.1]) (amavisd-new, port 10024)
	with ESMTP id G9mDfY6eXs_E; Thu, 24 Feb 2022 18:56:40 +0000 (UTC)
Received: from [127.0.1.1] (unknown [IPv6:2a01:4f8:120:8470::1:7])
	by mail.osmocom.org (Postfix) with ESMTP id A715028398;
	Thu, 24 Feb 2022 18:56:38 +0000 (UTC)
Received: from mail.osmocom.org (mail.osmocom.org [IPv6:2001:780:45:1d::46:82])
	by lists (Postfix) with ESMTPS id 7314C38A181C
	for <osmocom-net-gprs@lists.osmocom.org>; Thu, 24 Feb 2022 18:56:36 +0000 (UTC)
Received: from localhost (localhost [127.0.0.1])
	by mail.osmocom.org (Postfix) with ESMTP id 500BD28398
	for <osmocom-net-gprs@lists.osmocom.org>; Thu, 24 Feb 2022 18:56:36 +0000 (UTC)
Received: from mail.osmocom.org ([127.0.0.1])
	by localhost (mail.osmocom.org [127.0.0.1]) (amavisd-new, port 10024)
	with ESMTP id YOOQGySs-URv for <osmocom-net-gprs@lists.osmocom.org>;
	Thu, 24 Feb 2022 18:56:33 +0000 (UTC)
Received: from mga14.intel.com (mga14.intel.com [192.55.52.115])
	by mail.osmocom.org (Postfix) with ESMTPS id 614842838D
	for <osmocom-net-gprs@lists.osmocom.org>; Thu, 24 Feb 2022 18:56:32 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1645728992; x=1677264992;
  h=from:to:cc:subject:date:message-id:in-reply-to:
   references:mime-version:content-transfer-encoding;
  bh=PvdlZRuURqUV8Ds1k/Ga4T0xI20gL/29Zf8mMo+lcQU=;
  b=mtMpwUhwcHugOVeZLTKKQ8xJ+gIpzqR2UrIJXJotrZvudsaOh7wWUK8P
   z6a1KoUd4LyojanJnPmS5ht9fS/9x10cbO2EQlBQUb5QkQaA7mpJfjEXw
   /QSDIpg1542tr7oo2yZ3/+LlBhK46hErL6273wz/c46rlF7BA9KGuaMBg
   P5SMmSpK0V/8N5nkXedeAvbjzuKh2s7gKdlm1bC9qEr3wEfKa1c3s+c+R
   FieRna5AAG7sOWn3lq/OqHCL6sSedKwVE1EmDyHgpoSjibQ4GKPRjK1MN
   LXYl+CdVEvIa5JTcLDnvhr6E/aDkb3QRw4y/9u0jkqcwVrsTdHX2/1PNO
   g==;
X-IronPort-AV: E=McAfee;i="6200,9189,10268"; a="252515412"
X-IronPort-AV: E=Sophos;i="5.90,134,1643702400";
   d="scan'208";a="252515412"
Received: from fmsmga004.fm.intel.com ([10.253.24.48])
  by fmsmga103.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 24 Feb 2022 10:55:23 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.90,134,1643702400";
   d="scan'208";a="607521230"
Received: from irvmail001.ir.intel.com ([10.43.11.63])
  by fmsmga004.fm.intel.com with ESMTP; 24 Feb 2022 10:55:21 -0800
Received: from rozewie.igk.intel.com (rozewie.igk.intel.com [10.211.8.69])
	by irvmail001.ir.intel.com (8.14.3/8.13.6/MailSET/Hub) with ESMTP id 21OIt5Z4018029;
	Thu, 24 Feb 2022 18:55:19 GMT
From: Marcin Szycik <marcin.szycik@linux.intel.com>
To: netdev@vger.kernel.org
Subject: [PATCH net-next v9 7/7] ice: Support GTP-U and GTP-C offload in switchdev
Date: Thu, 24 Feb 2022 19:55:00 +0100
Message-Id: <20220224185500.18384-8-marcin.szycik@linux.intel.com>
...
Message-ID-Hash: KGCTFIV6GI6GY37N427AY54HLPNGI4AZ
X-Message-ID-Hash: KGCTFIV6GI6GY37N427AY54HLPNGI4AZ
...
Archived-At: <https://lists.osmocom.org/hyperkitty/list/osmocom-net-gprs@lists.osmocom.org/message/KGCTFIV6GI6GY37N427AY54HLPNGI4AZ/>
...
index 915aa693170c..cecd1f38fb8d 100644
...
@@ -4798,11 +5300,85 @@ ice_find_dummy_packet(struct ice_adv_lkup_elem *l=
kups, u16 lkups_cnt,
...
@@ -4817,7 +5393,7 @@ ice_find_dummy_packet(struct ice_adv_lkup_elem *lku=
ps, u16 lkups_cnt,
=20
...
@@ -4830,7 +5406,7 @@ ice_find_dummy_packet(struct ice_adv_lkup_elem *lku=
ps, u16 lkups_cnt,
 		return;
 	}
=20
...
@@ -4841,7 +5417,7 @@ ice_find_dummy_packet(struct ice_adv_lkup_elem *lku=
ps, u16 lkups_cnt,
...
@@ -4852,7 +5428,7 @@ ice_find_dummy_packet(struct ice_adv_lkup_elem *lku=
ps, u16 lkups_cnt,
...
@@ -4957,6 +5533,10 @@ ice_fill_adv_dummy_packet(struct ice_adv_lkup_elem=
 *lkups, u16 lkups_cnt,
 		case ICE_GENEVE:
