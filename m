...
Received: from mail.osmocom.org (mail.osmocom.org [213.95.46.82])
	by mail.lfdr.de (Postfix) with ESMTPS id E7B629D9459
	for <lists+osmocom-net-gprs@lfdr.de>; Tue, 26 Nov 2024 10:26:53 +0100 (CET)
Received: from localhost (mail.osmocom.org [127.0.0.1])
	by mail.osmocom.org (Postfix) with ESMTP id D446F191BBF;
	Tue, 26 Nov 2024 09:26:53 +0000 (UTC)
Received: from mail.osmocom.org ([127.0.0.1])
 by localhost (mail.osmocom.org [127.0.0.1]) (amavis, port 10024) with ESMTP
 id g9W6QMDNnjtn; Tue, 26 Nov 2024 09:26:52 +0000 (UTC)
Received: from [127.0.1.1] (unknown [IPv6:2a01:4f8:120:8470::1:7])
	by mail.osmocom.org (Postfix) with ESMTP id 03B69191B96;
	Tue, 26 Nov 2024 09:26:51 +0000 (UTC)
Received: from mail.osmocom.org (mail.osmocom.org [IPv6:2001:780:45:1d::46:82])
	by lists (Postfix) with ESMTPS id 1278338A1A94
	for <osmocom-net-gprs@lists.osmocom.org>; Mon, 18 Nov 2024 14:33:45 +0000 (UTC)
Received: from localhost (mail.osmocom.org [127.0.0.1])
	by mail.osmocom.org (Postfix) with ESMTP id ED972182458
	for <osmocom-net-gprs@lists.osmocom.org>; Mon, 18 Nov 2024 14:33:44 +0000 (UTC)
Received: from mail.osmocom.org ([127.0.0.1])
 by localhost (mail.osmocom.org [127.0.0.1]) (amavis, port 10024) with ESMTP
 id gIjl6OfntsyD for <osmocom-net-gprs@lists.osmocom.org>;
 Mon, 18 Nov 2024 14:33:43 +0000 (UTC)
Received: from mail-pj1-x102a.google.com (mail-pj1-x102a.google.com [IPv6:2607:f8b0:4864:20::102a])
	by mail.osmocom.org (Postfix) with ESMTPS id 75D54182453
	for <osmocom-net-gprs@lists.osmocom.org>; Mon, 18 Nov 2024 14:33:42 +0000 (UTC)
Received: by mail-pj1-x102a.google.com with SMTP id 98e67ed59e1d1-2e59746062fso2491370a91.2
        for <osmocom-net-gprs@lists.osmocom.org>; Mon, 18 Nov 2024 06:33:42 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20230601; t=1731940421; x=1732545221; darn=lists.osmocom.org;
        h=content-transfer-encoding:mime-version:references:in-reply-to
         :message-id:date:subject:cc:to:from:from:to:cc:subject:date
         :message-id:reply-to;
        bh=GM6DijP77xLrIB35oGS2bZGxiCeTwFC3rIdRrrFPg2U=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=GM6DijP77xLrIB35oGS2bZGxiCeTwFC3rIdRrrFPg2U=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCX8jozzXPzy2yyL2Jw90CYxkBI07XKKmo6Oa+mcacbsxXG8go7EN9U9ptfyFaNuhtX6doGEUCuMljjFJ4pWkkD8@lists.osmocom.org
X-Gm-Message-State: AOJu0YyZbHhPMuPaNUiJuOgCSXk4b30YdgjP7EGnvY1eDJtEaP/OgcBT
	yLQIcUuLvunTrn2D5pktyo+wsX8yHOJbHI8pJJodmQY/xR0YDMJo
...
Archived-At: <https://lists.osmocom.org/hyperkitty/list/osmocom-net-gprs@lists.osmocom.org/message/PL5YQORJT6XVH7IJYTXHX4LFBSKXYZVA/>
...
+	struct net *link_net =3D rtnl_newlink_link_net(params);
 	...
 	struct net *peer_net;
@@ -203,7 +206,7 @@ static int vxcan_newlink(struct net *net, struct net_=
device *dev,
 		name_assign_type =3D NET_NAME_ENUM;
 	}
=20
-	peer_net =3D rtnl_link_get_net(net, tbp);
+	peer_net =3D rtnl_link_get_net(link_net, tbp);
...
@@ -385,7 +388,7 @@ static int netkit_new_link(struct net *src_net, struc=
t net_device *dev,
 	    (tb[IFLA_ADDRESS] || tbp[IFLA_ADDRESS]))
 		return -EOPNOTSUPP;
=20
-	net =3D rtnl_link_get_net(src_net, tbp);
+	net =3D rtnl_link_get_net(link_net, tbp);
...
@@ -1800,7 +1803,7 @@ static int veth_newlink(struct net *src_net, struct=
 net_device *dev,
 		name_assign_type =3D NET_NAME_ENUM;
 	}
=20
...
--- a/drivers/net/vrf.c
+++ b/drivers/net/vrf.c
@@ -1698,10 +1698,11 @@ static void vrf_dellink(struct net_device *dev, s=
...
@@ -69,6 +69,34 @@ static inline int rtnl_msg_family(const struct nlmsghd=
r *nlh)
 		return AF_UNSPEC;
 }
=20
...
@@ -1071,10 +1071,10 @@ static int batadv_softif_validate(struct nlattr *=
...
@@ -3750,6 +3750,13 @@ static int rtnl_newlink_create(struct sk_buff *skb=
...
=20
 	if (!ops->alloc && !ops->setup)
 		return -EOPNOTSUPP;
@@ -3761,17 +3768,18 @@ static int rtnl_newlink_create(struct sk_buff *sk=
...
+		err =3D ops->newlink(&params);
 	...
 	if (err < 0) {
@@ -3782,11 +3790,6 @@ static int rtnl_newlink_create(struct sk_buff *skb=
, struct ifinfomsg *ifm,
